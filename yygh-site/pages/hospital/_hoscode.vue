        ...
        <div class="common-header">
          <div class="title-wrapper">
            ...
            <div class="icon-wrapper">
              <span class="iconfont"></span>{{ hospital.param.hospTypeString }}
            </div>
          </div>
        </div>
...
// getDepartmentListByHospCode
  methods: {
    init() {
      hospitalApi.getHospDetailsByHospCode(this.hoscode).then((response) => {
        this.hospital = response.data.hospital;
        this.bookingRule = response.data.bookingRule;
      });

      hospitalApi.getDepartmentListByHospCode(this.hoscode).then((response) => {
