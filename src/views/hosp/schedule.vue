<template>
    ...
    <div class="app-container">
        <div style="margin-bottom: 10px;font-size: 10px;">科室选择: {{ baseMap.hosname }}  /  {{ depname }}  /  {{ workDate }}</div>
            <el-container style="height: 100%">
                ...
                <el-main style="padding: 0 0 0 20px;">
                    ...
                    <el-row style="width: 100%">
                        ...
                        :type="index == activeIndex ? '' : 'info'" style="height: 60px;margin-right: 5px;margin-right:15px;cursor:pointer;">
...
export default {
    ...
    methods:{
        fetchData() {
            hospitalApi.queryAllDeptByHospCode(this.hoscode)
                .then(response => {
        ...
        getScheduleRule() {
            hospitalApi.getScheduleRule(this.page, this.limit, this.hoscode, this.depcode).then(response => {
