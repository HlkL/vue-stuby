<template>
    <div class="app-container">
        <h4 style="color: #6776A3">基本信息</h4>
        <table class="table table-striped table-condenseda table-bordered" width="100%">
            <tbody>
                <tr>
                    <th width="15%">医院名称</th>
                    <td width="35%"><b style="font-size: 14px">{{ hospital.hosname }}</b> | {{ hospital.param.hospTypeString }}</td>
                ...
                <tr>
                    ...
                    <th>地址</th>
                    <td>{{ hospital.param.addressString }}</td>
                </tr>
                <tr>
                    <th>坐车路线</th>
